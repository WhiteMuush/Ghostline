...
case "$menu_type" in
    ...
    echo ""
    echo -e "  ${BRIGHT_RED}Creator: \e]8;;https://github.com/WhiteMuush\aMelvin PETIT\e]8;;\a   ${BRIGHT_RED}${BOLD}Authorized targets only${RESET}"
    echo ""
}
...
handle_config_menu() {
    while true; do
        ...
        echo -ne "                                                 ${BOLD}${BRIGHT_RED}▪ Configure : ${RESET}"
        read -r choice
...
handle_passive_menu() {
    while true; do
        ...
        echo -ne "                                                 ${BOLD}${BRIGHT_RED}▪ Passive Recon : ${RESET}"
        read -r choice
...
handle_active_menu() {
    while true; do
        ...
        echo -ne "                                                 ${BOLD}${BRIGHT_RED}▪ Active Enum : ${RESET}"
        read -r choice
...
handle_special_menu() {
    while true; do
        ...
        echo -ne "                                                 ${BOLD}${BRIGHT_RED}▪ Special Ops : ${RESET}"
        read -r choice
